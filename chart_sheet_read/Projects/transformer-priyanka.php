...
$htmBaseIndex = 0;
$circle = "CIRCLE WISE DETAILS OF UNAUTHORISED IP SETS AS PER GOK ORDER EN09 PSR 2004 DATED 15-03-15 AS ATA THE END OF DEC-17";
...
foreach ($aarray as $key => $value) {
    ...
    $htmlI = 'CIRCLE WISE DETAILS OF UNAUTHORISED IP SETS AS PER GOK ORDER EN09 PSR 2004 DATED 15-03-15 AS ATA THE END OF DEC-17';
