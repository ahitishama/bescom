...
$sql = "select f_filename from file_uploads where f_mid=5 and f_sid=22 and f_hid=18 and f_fid=0 order by fid desc";
$result = $con->query($sql);
$row=mysqli_fetch_array($result,MYSQLI_NUM);

$inputFileName = '../../uploads/Projects/NJY/'.$row['0'];
//$inputFileName = 'njy.xlsx';
...
$htmBaseIndex = 0;
$circle = "ABSTRACT of NJY Phase -1 Scheme";
...
foreach ($aarray as $key => $value) {
    ...
    $htmlI = 'ABSTRACT of NJY Phase -1 Scheme';
