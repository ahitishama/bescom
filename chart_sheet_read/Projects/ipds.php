...
$htmBaseIndex = 0;
$circle = "Integrated Power Development Scheme </br><small>Name of Executing Agency: M/s. Maruthi Mechanicals & Electricals(P) Ltd., /Bangalore. DWA Amount: Rs. 9.418 Crores Name of Circle : BANGALORE RURAL Date of Completion: 07.01.2019</small>";
...
foreach ($aarray as $key => $value) {
    ...
    $htmlI = 'Integrated Power Development Scheme </br><small>Name of Executing Agency: M/s. Maruthi Mechanicals & Electricals(P) Ltd., /Bangalore. DWA Amount: Rs. 9.418 Crores Name of Circle : BANGALORE RURAL Date of Completion: 07.01.2019</small>';
