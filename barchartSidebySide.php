...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
	  <?php if($_GET['file'] == 'mc_ea') { if($_GET['st']=='sheet1') { echo 'CTAZ'; } else if($_GET['st']=='sheet2') { echo 'BRAZ'; } else if($_GET['st']=='sheet3') { echo 'BMAZ'; } else if($_GET['st']=='sheet4') { echo '24 Towns'; } } else if($_GET['file'] == 'projects') { if($_GET['st']=='ddugjy') { echo 'DDUGJY'; } else if($_GET['st']=='ipds') { echo 'IPDS'; } else if($_GET['st']=='transformer') { echo 'TRANSFORMER STRUCTURE REDESIGN'; } else if($_GET['st']=='unip') { echo 'UNIP'; } else if($_GET['st']=='njy_s1') { echo ' NJY_CURRENT_MONTH'; } else if($_GET['st']=='njy_last_month') { echo 'NJY_LAST_MONTH'; } }  else {}  ?>
     
      </h1>
     <ol class="breadcrumb">
        <li><a href="a&rt.php?file=general&st=Present"><i class="fa fa-dashboard"></i> Home</a></li>
      </ol>
    </section>
